        ...
        <Grid col={4} mdCol={2} smCol={1} gap={10}>
          <div>
            ...
            <div className="footer__content">
              <p>
                Liên hệ đặt hàng: <strong>0348 240 175</strong>
              </p>
              <p>
                Thắc mắc đơn hàng: <strong>0355 751 581</strong>
              </p>
              <p>
                Góp ý, khiếu nại: <strong>0969 565 435 </strong>
              </p>
            </div>
          </div>
          ...
          <div className="footer__about">
            <p>
              <Link to="/">
                <img alt="" className="footer__logo" src={logo} />
              </Link>
            </p>
            <p>
