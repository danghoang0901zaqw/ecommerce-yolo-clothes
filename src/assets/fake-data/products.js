...
const getCartItemDetail = (cartItem) => {
  const newArr = [];
  if (cartItem.length > 0) {
    cartItem.forEach((item) => newArr.push({
      ...item,
      product:productData.getProductBySlug(item.slug)
    }));
  }
  return newArr;
};
